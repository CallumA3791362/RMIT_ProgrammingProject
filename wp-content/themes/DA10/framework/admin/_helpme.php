...
<div id="sidebar_help">
  ...
  <div class="border-bottom text-center text-uppercase" id="hidembtn" >
    <div class="btn-group d-flex justify-content-between position-absolute w-100" style="bottom:0px;"  >
      ...
      <button type="button" class="btn btn-secondary"  onclick="jQuery('#sidebar_help_icon').removeClass('hideme');jQuery('#sidebar_help').removeClass('showme');" style="background: red; border-color:red;"><?php echo __("Hide Me","premiumpress"); ?></button>
    </div>
  </div>
</div>
<style>
