      ...
      <div class="row">
        <div class="col-3">
          ...
          <?php if(in_array(_ppt("cashoutopt_bank"), array("","1"))){ ?>
           ...
           <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fa fa-money-check-alt"></i>  <?php echo __("Bank","premiumpress"); ?></a>
