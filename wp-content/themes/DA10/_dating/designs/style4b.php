...
add_filter( 'ppt_admin_layouts',  array('da_style4b',  'data') );
add_filter( 'da_style4b',  array('da_style4b',  'load') );
...
$core['design']['font_logo'] = "";
	...
	$core['design']['logo_url'] = _ppt_demopath()."/style4/logo2.png";
	$core['design']['light_logo_url_aid'] = "1";
	$core['design']['light_logo_url'] = _ppt_demopath()."/style4/logo2.png";
...
$core['design']['color_primary'] = "#a6a236";
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style4/hero2.jpg";     
        ...
        $core["home"]["text1"]["text_image1"] = _ppt_demopath()."/style4/image2.jpg";     
