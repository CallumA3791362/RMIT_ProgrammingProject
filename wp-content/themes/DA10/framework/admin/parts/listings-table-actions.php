...
?><div class="py-4">
 ...
 <select class="form-control" name="mass-status" id="mass-status">
      ...
      <?php } ?>
        ...
        <button class="btn btn-system shadow-sm btn-block mt-4 font-weight-bold btn-md" type="button" onclick="ajax_massupdate_listings();"><?php echo __("Update","premiumpress"); ?> </button>
