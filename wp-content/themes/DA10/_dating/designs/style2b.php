...
add_filter( 'ppt_admin_layouts',  array('da_style2b',  'data') );
add_filter( 'da_style2b',  array('da_style2b',  'load') );
...
class da_style2b {
	...
	public static function data($a){ 
		...
		$a['da_style2b'] = array(
			...
			"name" 	=> "Style 1b",
			"image"	=> _ppt_demopath()."/designs/style2b.jpg",
...
$core['design']['color_secondary'] = "#0c283a";
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "Search Now";     
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style2/hero2.jpg";     
        ...
        $core["home"]["text2"]["title"] = "We put you in touch with some of the best dates near you.";     
        ...
        $core["home"]["cta1"]["title"] = "Setup your free profile today!";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = _ppt_demopath()."/style2/hero3.jpg"; 		
