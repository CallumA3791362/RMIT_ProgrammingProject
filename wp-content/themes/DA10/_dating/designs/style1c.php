...
add_filter( 'ppt_admin_layouts',  array('da_style1c',  'data') );
add_filter( 'da_style1c',  array('da_style1c',  'load') );
...
class da_style1c {
	...
	public static function data($a){ 
		...
		$a['da_style1c'] = array(
			...
			"name" 	=> "Style 1c",
			"image"	=> _ppt_demopath()."/designs/style1c.jpg",
...
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["text2"]["title"] = "Welcome to <i class='fal fa-bow-arrow ml-2'></i> <span>Escorts</span>Online";     
        ...
        $core["home"]["text2"]["btn_txt"] = "Find an escort";     
