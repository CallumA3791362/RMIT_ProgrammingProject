...
$settings = array("title" => "User Emails", "desc" => "Here you can turn on/off email sent to users.", "video" => "https://www.youtube.com/watch?v=A23nzR48OkU");
...
<div class="container px-0">
            <div class="row py-2">
              ...
              <div class="col-md-3 pl-0">
                ...
                <a href="javascript:void(0);" onclick="jQuery('#<?php echo $key; ?>_showemail').toggle();" class="btn btn-block btn-system shadow-sm btn-md rounded-0 px-4 mt-n2"><?php echo __("Edit Email","premiumpress"); ?></a>
