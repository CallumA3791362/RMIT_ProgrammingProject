...
<?php } ?>
<div id="content" class="position-relative"  style="max-width:1100px;">
...
<a href="https://www.premiumpress.com/account/" class="btn btn-primary float-right">Renew Now</a>

<h4>Your PremiumPress updates have expired</h4>
