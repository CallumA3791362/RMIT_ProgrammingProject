...
add_filter( 'ppt_admin_layouts',  array('da_style3d',  'data') );
add_filter( 'da_style3d',  array('da_style3d',  'load') );
...
class da_style3d {
	...
	public static function data($a){ 
		...
		$a['da_style3d'] = array(
			...
			"name" 	=> "fashion 4",
			"image"	=> _ppt_demopath()."/designs/style3d.jpg",
...
$core['design']['slot4_style'] = "cta1";
$core['design']['slot5_style'] = "listings7a";
...
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_search2"]["title"] = "Find a date today!";     
        $core["home"]["hero_search2"]["subtitle"] = "Over 1,000 members online.";   
        ...
        $core["home"]["hero_search2"]["btn_txt"] = "View Escorts";     
        ...
        $core["home"]["hero_search2"]["hero_image"] = _ppt_demopath()."/style3/hero3.jpg";     
  ...
  /* testimonials3a */    
        ...
        $core["home"]["text1"]["subtitle"] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";     
        $core["home"]["text1"]["desc"] = "";     
        ...
        $core["home"]["listings3a"]["subtitle"] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";     
