...
add_filter( 'ppt_admin_layouts',  array('da_style4e',  'data') );
add_filter( 'da_style4e',  array('da_style4e',  'load') );
...
class da_style4e {
	...
	public static function data($a){ 
		...
		$a['da_style4e'] = array(
			...
			"name" 	=> "Style 4a",
			"image"	=> _ppt_demopath()."/designs/style4e.jpg",
...
$core['design']['font_logo'] = "";
	...
	$core['design']['logo_url'] = _ppt_demopath()."/style4/logo5.png";
	$core['design']['light_logo_url_aid'] = "1";
	$core['design']['light_logo_url'] = _ppt_demopath()."/style4/logo5.png";
...
$core['design']['color_primary'] = "#6d7070";
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style4/hero5.jpg";     
        ...
        $core["home"]["listings3"]["custom"] = "men"; 		
        ...
        $core["home"]["text1"]["text_image1"] = _ppt_demopath()."/style4/image5.jpg";     
