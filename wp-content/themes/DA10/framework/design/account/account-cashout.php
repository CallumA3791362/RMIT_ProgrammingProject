...
$payment_due = round($user_credit,2);
        ...
        <form  role="form" method="post" action="" onsubmit="return CheckFormData();" class="mb-4 mt-3" id="cashoutform">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="input-group" style="width:200px;"> <span class="input-group-prepend input-group-text bg-white rounded-0"><?php echo _ppt(array('currency','symbol')); ?></span>
  ...
  <?php } ?>
    ...
    <div class="card text-center mt-5">
      <div class="card-header bg-white"><?php echo __("Payment Method","premiumpress"); ?></div>
      <div class="card-body">
