...
<a href="<?php echo _ppt(array('links','add')); ?>" class="float-right btn btn-primary hide-mobile"><?php echo __("Add New","premiumpress") ?> </a>
  ...
  <div class="tabbable-line ">
    <ul class="nav nav-tabs clearfix">
     ...
     <li class="nav-item"> <a href="javascript:void(0);" onclick="showlistings('all');" class="nav-link py-3  active" data-toggle="tab"  role="tab">
     <span class="px-lg-2 "><?php echo __("All","premiumpress") ?> </span> <span class="badge badge-pill" id="count-status-all">0</span> </a> 
     </li>
      
      <li class="nav-item"> <a href="javascript:void(0);" onclick="showlistings('publish');" class="nav-link py-3" data-toggle="tab"  role="tab">
      <span class="px-lg-2 "><?php echo __("Live","premiumpress") ?> </span> <span class="badge badge-pill" id="count-status-publish">0</span> </a>
      </li>
      
      
      <li class="nav-item"> <a href="javascript:void(0);" onclick="showlistings('pending');" class="nav-link py-3  " data-toggle="tab"  role="tab"> <span class="px-lg-2 "> <?php echo __("Pending","premiumpress") ?></span> <span class="badge   badge-pill" id="count-status-pending">0</span> </a> </li>
      <li class="nav-item"> <a href="javascript:void(0);" onclick="showlistings('expired');" class="nav-link py-3  " data-toggle="tab"  role="tab"> <span class="px-lg-2 "> <?php echo __("Expired","premiumpress") ?></span> <span class="badge badge-pill" id="count-status-expired">0</span> </a> </li>
...
?>
<div class="border-bottom bg-white shadow-sm mb-4 status-<?php if(in_array($ss, array("pending","payment","pending_approval") )){ echo "pending"; }else{ echo $ss; } ?> p-3 listingid-<?php echo $list->ID; ?>">
  <div class="row y-middle">
    <div class="col-6 col-md-6 col-lg-5">
      ...
      <div class="ellipsis" style="max-width:200px;">
        ...
        <?php if($ss != "trash"){ ?>
        <a href="<?php echo get_permalink($list->ID); ?>" class="text-dark font-weight-bold" target="_blank"> <?php echo get_the_title($list->ID); ?></a>
        <?php }else{ ?>
    ...
    <div class="col-2 hide-ipad hide-mobile">
     ...
     <?php }elseif($listingstatus['key'] == "publish" && get_post_meta($list->ID, 'listing_expiry_date',true) != "" ){ ?>
     
     
      <div class="font-weight-bold">
     <?php echo do_shortcode('[TIMELEFT postid="'.$list->ID .'" layout="1" text_before="" text_ended="Not Set" key="listing_expiry_date"]'); ?>
