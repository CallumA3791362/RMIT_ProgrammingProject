...
if(strlen($footer1) > 10){ echo $footer1; }else{	 
?>
        <div class="h5"><?php echo __("Join our newsletter","premiumpress"); ?></div>
        ...
        <?php 
							...
							ob_end_clean();	
							if($settings['section_bg'] != "bg-secondary"){
							...
							echo $output;
							 ...
							 ?>
        <div class="small opacity-8 mt-4"><?php echo __("We'll never share your details. See our","premiumpress"); ?> <a class="opacity-8" href="<?php echo _ppt(array('links','privacy')); ?>"><?php echo __("Privacy Policy","premiumpress"); ?></a></div>
        <?php } ?>
      </div>
