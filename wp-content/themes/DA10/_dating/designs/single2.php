...
add_filter( 'ppt_admin_layouts',  array('da_single2',  'data') );
add_filter( 'da_single2',  array('da_single2',  'load') );
...
class da_single2 {
	...
	public static function data($a){ 
		...
		$a['da_single2'] = array(
			...
			"name" 	=> "Style 2",
			"image"	=> _ppt_demopath()."/designs/da_single2.jpg",
...
$core['design']['slot1_style'] = "intro_5";
...
$core['design']['slot9_style'] = '';
        ...
        /* intro_5 */    
        $core["home"]["intro_5"]["section_padding"] = "";     
        $core["home"]["intro_5"]["section_bg"] = "bg-white";     
        $core["home"]["intro_5"]["section_pos"] = "";     
        $core["home"]["intro_5"]["section_w"] = "container";     
        $core["home"]["intro_5"]["section_pattern"] = "";     
        $core["home"]["intro_5"]["title_show"] = "yes";     
        $core["home"]["intro_5"]["title"] = __("Meet Someone <br> New Today","premiumpress");     
        $core["home"]["intro_5"]["subtitle"] = " ";     
        $core["home"]["intro_5"]["desc"] = __("If you are seeking love and want an easy way to meet local singles, your in the right place. Create your free profile now and start meeting local singles today!","premiumpress");    
        $core["home"]["intro_5"]["title_style"] = "1";     
        $core["home"]["intro_5"]["title_pos"] = "left";     
        $core["home"]["intro_5"]["title_heading"] = "h1";     
        $core["home"]["intro_5"]["title_margin"] = "mb-4";     
        $core["home"]["intro_5"]["subtitle_margin"] = "mb-4";     
        $core["home"]["intro_5"]["desc_margin"] = "mb-4";     
        $core["home"]["intro_5"]["title_txtcolor"] = "dark";     
        $core["home"]["intro_5"]["subtitle_txtcolor"] = "dark";     
        $core["home"]["intro_5"]["desc_txtcolor"] = "dark";     
        $core["home"]["intro_5"]["title_font"] = "";     
        $core["home"]["intro_5"]["subtitle_font"] = "";     
        $core["home"]["intro_5"]["desc_font"] = "";     
        $core["home"]["intro_5"]["title_txtw"] = "font-weight-bold";     
        $core["home"]["intro_5"]["subtitle_txtw"] = "font-weight-bold";     
        $core["home"]["intro_5"]["btn_show"] = "yes";     
        $core["home"]["intro_5"]["btn_link"] = "";     
        $core["home"]["intro_5"]["btn_txt"] = "Register Now";     
        $core["home"]["intro_5"]["btn_bg"] = "dark";     
        $core["home"]["intro_5"]["btn_bg_txt"] = "";     
        $core["home"]["intro_5"]["btn_icon"] = "far fa-bookmark";     
        $core["home"]["intro_5"]["btn_icon_pos"] = "before";     
        $core["home"]["intro_5"]["btn_size"] = "btn-xl";     
        $core["home"]["intro_5"]["btn_margin"] = "mt-4";     
        $core["home"]["intro_5"]["btn_style"] = "4";     
        $core["home"]["intro_5"]["btn_font"] = "";     
        $core["home"]["intro_5"]["hero_image"] = "";     
        $core["home"]["intro_5"]["hero_size"] = "hero-medium";     
        $core["home"]["intro_5"]["hero_overlay"] = "";     
        $core["home"]["intro_5"]["hero_txtcolor"] = "light"; 
		
		$core["home"]["intro_5"]["hero_image"] = _ppt_demopath()."/single/hero2.jpg";  
        ...
        $core["home"]["faq4"]["image_faq"] = _ppt_demopath()."/single/image2.jpg"; 	
