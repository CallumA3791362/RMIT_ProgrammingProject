...
add_filter( 'ppt_admin_layouts',  array('da_style3b',  'data') );
add_filter( 'da_style3b',  array('da_style3b',  'load') );
...
$core['design']['color_secondary'] = "#1a1a1a";
       ...
       $core["home"]["listings3"]["custom"] = "women"; 	   
        ...
        $core["home"]["text2"]["text_image1"] = _ppt_demopath()."/style3/image1.jpg";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = _ppt_demopath()."/style3/hero3.jpg"; 		
