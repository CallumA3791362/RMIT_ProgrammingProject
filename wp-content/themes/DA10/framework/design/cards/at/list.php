...
<div class="col-md-8 col-xl-10 col-lg-9 text-center text-md-left">
    ...
    <ul class="list-inline small opacity-5 hide-mobile">    	
     ...
     <li class="list-inline-item"><i class="fal fa-users mr-2"></i> <?php echo do_shortcode('[BIDS]'); ?> <?php echo __("Bids","premiumpress"); ?> </li> 
...
<div class="col-md-4 col-xl-2 col-lg-3 text-center text-lg-right">
    ...
    <div class="tiny text-uppercase opacity-5 hide-mobile hide-ipad"><?php echo __("Current Price","premiumpress"); ?></div>
