...
<a href="javascript:void(0);" onClick="jQuery('.cfielditem').hide();jQuery('#ppt__regions').clone().insertAfter('#ppt__regionss');jQuery('#noaddregions').hide();" class="btn btn-system btn-md shadow-sm float-right"><i class="fal fa-plus"></i> <?php echo __("Add New","premiumpress"); ?></a>	 

<a href="#quickAdd" role="button" data-toggle="modal" class="btn btn-system btn-md shadow-sm float-right mr-3" style="float:right;margin-left:10px;"><i class="fal fa-globe"></i> <?php echo __("Popular","premiumpress"); ?></a>
...
<div class="modal-dialog" role="document">
 ...
 <a href="admin.php?page=cart&add_pre_usa=1&lefttab=regions" onclick="jQuery('#ShowTab').val('regions');" class="btn btn-system btn-md float-right shadow-sm"> <?php echo __("Continue","premiumpress"); ?></a>  
     	
        <h4>USA Tax States</h4>
         
        <hr />
        <a href="admin.php?page=cart&add_pre_usa=3&lefttab=regions" onclick="jQuery('#ShowTab').val('regions');"  class="btn btn-system btn-md float-right shadow-sm"><?php echo __("Continue","premiumpress"); ?></a>
       
        <h4>Canadian Tax States</h4>
          
        <hr />
        <a href="admin.php?page=cart&add_pre_usa=2&lefttab=regions" onclick="jQuery('#ShowTab').val('regions');" class="btn btn-system btn-md float-right shadow-sm"><?php echo __("Continue","premiumpress"); ?></a> 
...
if(in_array($regionslist['key'][$i], $setKeys) ){  
...
$setKeys[] = $regionslist['key'][$i];	 
 ...
 ?>
    ...
    <span class="opacity-5 float-right small mr-3"><?php echo $regionslist['key'][$i]; ?></span>
...
?>
   ...
   <input type="text" name="admin_values[regions][key][]" value="<?php echo $regionslist['key'][$i]; ?>"  class="form-control float-right" style="width:150px;" />      
