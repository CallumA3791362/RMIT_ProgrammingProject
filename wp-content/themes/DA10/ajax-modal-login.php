...
<div class="text-center py-3">
  <h1 class="h2 font-weight-bold"><?php echo __("Member Login","premiumpress") ?></h1>
...
<div class="text-center mt-4 mb-2 small"> <a href="<?php echo home_url(); ?>/wp-login.php?action=lostpassword" rel="nofollow"><u><?php echo __("Lost password?","premiumpress"); ?></u></a> </div>
