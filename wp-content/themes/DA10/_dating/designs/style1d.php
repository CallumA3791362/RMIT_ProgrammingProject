...
add_filter( 'ppt_admin_layouts',  array('da_style1d',  'data') );
add_filter( 'da_style1d',  array('da_style1d',  'load') );
...
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_search2"]["title"] = "Find an escrot today!";     
  ...
  /* testimonials3a */    
        ...
        $core["home"]["text1"]["btn_txt"] = "Find an escort";     
