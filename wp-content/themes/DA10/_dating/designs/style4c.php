...
add_filter( 'ppt_admin_layouts',  array('da_style4c',  'data') );
add_filter( 'da_style4c',  array('da_style4c',  'load') );
...
$core['design']['font_logo'] = "";
	...
	$core['design']['logo_url'] = _ppt_demopath()."/style4/logo3.png";
	$core['design']['light_logo_url_aid'] = "1";
	$core['design']['light_logo_url'] = _ppt_demopath()."/style4/logo3.png";
...
$core['design']['color_primary'] = "#ff4a52";
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style4/hero3.jpg";     
        ...
        $core["home"]["text1"]["text_image1"] = _ppt_demopath()."/style4/image3.jpg";     
