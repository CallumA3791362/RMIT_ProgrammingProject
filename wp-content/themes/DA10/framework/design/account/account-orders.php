   ...
   function ajax_load_order_payment(div,pp){
      ...
      <div class="card mb-5">
        <div class="card-header bg-white">
          <h6><?php echo __("All Transactions","premiumpress"); ?></h6>
          <p><span id="totalordersfound"><?php echo number_format(count($orders)); ?></span> <?php echo __("orders found","premiumpress"); ?> </p>
        </div>
          ...
          <table class="table small table-orders">
            <thead>
              <tr>
                ...
                <th class="text-center dashhideme"><?php echo __("Type","premiumpress"); ?></th>
                <th class="text-center"><?php echo __("Status","premiumpress"); ?></th>
                <th class="text-center dashhideme"><?php echo __("Actions","premiumpress"); ?></th>
              </tr>
            </thead>
            <tbody>
              <?php
