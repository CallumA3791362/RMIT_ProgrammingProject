			...
			if(is_array($regfields) && isset($regfields['dbkey']) ){ 
				...
				if($regfields['fieldtype'][$i] == "select"){ 
				 ...
				 $values = trim(stripslashes(str_replace("_"," ",str_replace("::",",", str_replace(";;","'", $values)))));
                            ...
                            <div class=" mb-3 fieldrow small fieldtype-<?php echo $regfields['fieldtype'][$i]; ?>">
                                                                              
                                            <div class="title btn-block mb-3"><?php echo $CORE->GEO("translate_field_name", array( stripslashes($regfields['name'][$i]), $i, $regfields)); ?></div>  
