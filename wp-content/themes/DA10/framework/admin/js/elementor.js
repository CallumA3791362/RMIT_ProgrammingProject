jQuery(document).ready(function(){ 
	...
	jQuery(".wp-admin.post-type-listing_type #side-sortables").prepend("<a href='admin.php?page=listings&eid="+jQuery('#post_ID').val()+"' class='button button-primary button-large' style='width:100%; margin-bottom:20px; font-size:16px; text-align:center; font-weight:bold;'>Edit with PremiumPress</a>")
