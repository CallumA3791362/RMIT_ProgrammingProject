...
<form <?php if($userdata->ID ){ ?>id="fileupload" action="<?php echo get_home_url(); ?>/index.php" method="POST" enctype="multipart/form-data"<?php } ?>>
  ...
  <div class="fileupload-buttonbar">
    ...
    <a href="javascript:void(0);"  <?php if(!isset($_GET['eid'])){ ?> onclick="SaveReloadMe1();"<?php }else{ ?>id="selectmediafile"<?php } ?> class="btn btn-system btn-sm <?php if(!isset($_GET['eid'])){ ?>opacity-5<?php } ?>"><?php echo __("select WP media file","premiumpress"); ?></a>
...
<script src="<?php echo FRAMREWORK_URI.'js/'; ?>js.plugins-upload.js?ver=10.5.4"></script>
