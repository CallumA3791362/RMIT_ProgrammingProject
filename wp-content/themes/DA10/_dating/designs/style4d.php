...
add_filter( 'ppt_admin_layouts',  array('da_style4d',  'data') );
add_filter( 'da_style4d',  array('da_style4d',  'load') );
...
$core['design']['font_logo'] = "";
	...
	$core['design']['logo_url'] = _ppt_demopath()."/style4/logo4.png";
	$core['design']['light_logo_url_aid'] = "1";
	$core['design']['light_logo_url'] = _ppt_demopath()."/style4/logo4.png";
...
$core['design']['color_primary'] = "#5bafd2";
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style4/hero4.jpg";     
        ...
        $core["home"]["text1"]["text_image1"] = _ppt_demopath()."/style4/image4.jpg";     
