...
add_filter( 'ppt_admin_layouts',  array('da_style3e',  'data') );
add_filter( 'da_style3e',  array('da_style3e',  'load') );
...
$core['design']['color_secondary'] = "#1a1a1a";
        ...
        $core["home"]["hero_search1"]["hero_image"] = _ppt_demopath()."/style3/hero4.jpg";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = _ppt_demopath()."/style3/hero1.jpg"; 		
