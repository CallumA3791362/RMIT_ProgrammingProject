    ...
    <div class=" p-3"><?php echo __("Please upgrade your membership to access this feature.","premiumpress"); ?></div>
      ...
      <?php if(isset($_GET['op']) && $_GET['op'] == "listings_max" && current_user_can('administrator')){ ?>
       <div class="col-md-12">
        ...
        <a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=membershipsetup" class="btn btn-dark">Go now</a>
...
?>
 ...
 <span class="inline-flex items-center mt-n3 font-weight-bold order-status-icon status-4" onclick="SwitchPage('membership');" style="cursor:pointer;"> <span class="dot mr-2"></span> <span class="pr-2px leading-relaxed whitespace-no-wrap"><?php echo __("Pending Approval","premiumpress"); ?> </span> </span>
 </div>
