...
$types = array(
	...
	"1-0" => array( 
		...
		"desc_buyer" 	=> __("Please wait for the %s to accept this","premiumpress")." %c",		
		"name_seller" 	=> __("Accept","premiumpress")." %c",
		"desc_seller" 	=> __("Please accept or decline this","premiumpress")." %c.",		
	...
	"3-2" => array( 
		...
		"desc_buyer" 	=> __("Please wait for the %s to deliver this","premiumpress")." %c.",		
		"name_seller" 	=> __("Please make delivery","premiumpress"),
		"desc_seller" 	=> __("Please deliver this %c to the","premiumpress")." %b.", 
	...
	"3-5" => array( 	
		...
		"desc_buyer" 	=> __("Please leave feedback for the","premiumpress")." %s.",		
		"name_seller" 	=> __("Leave Feedback","premiumpress"),
		"desc_seller" 	=> __("Please leave feedback for the","premiumpress")." %b.",	
...
if(_ppt(array('cashout', 'enable_escrow')) == '1'){
	$types["3-4"] = array( 
		...
		"desc_buyer" 		=> __("Please release funds to the","premiumpress")." %s.",		
...
<div class="card shadow-sm bg-white p-3 mb-4" <?php if($settings['feedback_date'] != ""){ ?>style="display:none;"<?php } ?>>
    <div class="row y-middle">
        <div class="col-md-8">
			...
			str_replace("%c", strtolower($CORE->LAYOUT("captions","offer")), $status_types['name_'.$mytype]))); ?></h3> 
        ...
        <?php }elseif($settings['job_'.$status_types['user'].'_id'] == $userdata->ID){ ?>
         ...
         <?php }elseif($status_key == "3-1"){ ?>
            ...
            <?php if(_ppt(array('cashout', 'enable_escrow')) == '1'){  ?>
       
           <button class="btn btn-primary btn-block" onclick="ajax_escrow_payment('escrow_<?php echo $settings['pid']; ?>','<?php echo hook_price($settings['order_total']); ?>');">
