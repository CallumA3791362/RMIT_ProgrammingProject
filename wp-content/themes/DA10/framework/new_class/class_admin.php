...
<?php }
	...
	add_menu_page('', "Installation", $DEFAULT_STATUS, 'premiumpress', array($this, '_admin_page_install' ), ''.esc_url( get_template_directory_uri() ).'/framework/admin/images/install.png', 3); 
	...
	//add_theme_page( 'Child Themes', 'Child Themes',  $DEFAULT_STATUS, 'premiumpresschildthemes', 'theme-install.php?browse=premiumpress', 12 );
		...
		// SITE OVERVIEW	 
		add_menu_page('', "PremiumPress",  $DEFAULT_STATUS, 'premiumpress', array($this, '_admin_page_install' ), get_template_directory_uri() .'/framework/admin/images/premiumpress.png', 4.1);
