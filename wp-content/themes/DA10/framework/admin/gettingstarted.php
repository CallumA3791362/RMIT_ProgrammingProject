...
?>
            <div class="col-md-4 mb-3">
              <div class="card-top-image card-zoom mb-0 design_<?php echo $h['key']; ?>">
                <figure style="min-height:150px;" class="<?php if($i == 1){  ?>selecteddesign<?php } ?>" >
                
                <img src="<?php echo $h['image']; ?>" class="img-fluid" alt="">
            ...
            <div class="bg-light py-2  text-left" style="border-top:1px solid #efefef;">
