...
add_filter( 'ppt_admin_layouts',  array('da_single1',  'data') );
add_filter( 'da_single1',  array('da_single1',  'load') );
...
class da_single1 {
	...
	public static function data($a){ 
		...
		$a['da_single1'] = array(
			...
			"name" 	=> "Style 1a",
			"image"	=> _ppt_demopath()."/designs/da_single1.jpg",
...
$core['design']['slot1_style'] = "intro_4";
...
$core['design']['slot9_style'] = '';
        ...
        /* intro_4 */    
        $core["home"]["intro_4"]["section_padding"] = "";     
        $core["home"]["intro_4"]["section_bg"] = "bg-white";     
        $core["home"]["intro_4"]["section_pos"] = "";     
        $core["home"]["intro_4"]["section_w"] = "container";     
        $core["home"]["intro_4"]["section_pattern"] = "";     
        $core["home"]["intro_4"]["title_show"] = "yes";     
        $core["home"]["intro_4"]["title"] = __("Meet Someone <br> New Today","premiumpress");     
        $core["home"]["intro_4"]["subtitle"] = " ";     
        $core["home"]["intro_4"]["desc"] = __("If you are seeking love and want an easy way to meet local singles, your in the right place. Create your free profile now and start meeting local singles today!","premiumpress");     
        $core["home"]["intro_4"]["title_style"] = "1";     
        $core["home"]["intro_4"]["title_pos"] = "left";     
        $core["home"]["intro_4"]["title_heading"] = "h1";     
        $core["home"]["intro_4"]["title_margin"] = "mb-4";     
        $core["home"]["intro_4"]["subtitle_margin"] = "mb-4";     
        $core["home"]["intro_4"]["desc_margin"] = "mb-4";     
        $core["home"]["intro_4"]["title_txtcolor"] = "white";     
        $core["home"]["intro_4"]["subtitle_txtcolor"] = "dark";     
        $core["home"]["intro_4"]["desc_txtcolor"] = "opacity-5";     
        $core["home"]["intro_4"]["title_font"] = "";     
        $core["home"]["intro_4"]["subtitle_font"] = "";     
        $core["home"]["intro_4"]["desc_font"] = "";     
        $core["home"]["intro_4"]["title_txtw"] = "font-weight-bold";     
        $core["home"]["intro_4"]["subtitle_txtw"] = "font-weight-bold";     
        $core["home"]["intro_4"]["btn_show"] = "yes";     
        $core["home"]["intro_4"]["btn_link"] = "";     
        $core["home"]["intro_4"]["btn_txt"] = "";     
        $core["home"]["intro_4"]["btn_bg"] = "light";     
        $core["home"]["intro_4"]["btn_bg_txt"] = "";     
        $core["home"]["intro_4"]["btn_icon"] = "far fa-bookmark";     
        $core["home"]["intro_4"]["btn_icon_pos"] = "before";     
        $core["home"]["intro_4"]["btn_size"] = "btn-xl";     
        $core["home"]["intro_4"]["btn_margin"] = "mt-4";     
        $core["home"]["intro_4"]["btn_style"] = "4";     
        $core["home"]["intro_4"]["btn_font"] = "";     
        $core["home"]["intro_4"]["hero_image"] = "";     
        $core["home"]["intro_4"]["hero_size"] = "hero-medium";     
        $core["home"]["intro_4"]["hero_overlay"] = "";     
        $core["home"]["intro_4"]["hero_txtcolor"] = "light"; 
		
		$core["home"]["intro_4"]["hero_image"] = _ppt_demopath()."/single/hero1.jpg";  
        ...
        $core["home"]["faq4"]["image_faq"] = _ppt_demopath()."/single/image1.jpg"; 	
