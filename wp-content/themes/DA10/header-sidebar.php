...
<div class="sidebar-content"> <a href="<?php echo home_url(); ?>" class="sidebar-logo btn-block mt-4"> <?php echo str_replace("-primary","-light",$CORE->LAYOUT("get_logo","light"));  ?> </a>
  ...
  <?php } ?>
  <?php }else{ ?>
  <a class="btn btn-light btn-md btn-block" href="<?php echo _ppt(array('links','myaccount')); ?>"> <?php echo __("My Account","premiumpress"); ?></a> <a href="<?php echo wp_logout_url(home_url()); ?>" class="btn btn-outline-light btn-md btn-block mt-4"><i class="fa fa-sign-out"></i> <?php echo __("Logout","premiumpress"); ?></a>
  <?php } ?>
