...
add_filter( 'ppt_admin_layouts',  array('da_style2d',  'data') );
add_filter( 'da_style2d',  array('da_style2d',  'load') );
...
class da_style2d {
	...
	public static function data($a){ 
		...
		$a['da_style2d'] = array(
			...
			"name" 	=> "fashion 4",
			"image"	=> _ppt_demopath()."/designs/style2d.jpg",
...
$core['design']['color_secondary'] = "#0c283a";
        ...
        $core["home"]["hero_search2"]["hero_image"] = _ppt_demopath()."/style2/hero3.jpg";     
