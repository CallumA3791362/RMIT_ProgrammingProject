...
global $CORE, $post, $userdata; 
   ...
   if($price_shipping == "" || !is_numeric($price_shipping)){$price_shipping = 0; }
      ...
      <div class=" card mt-5 mb-4 rounded-0 border-0" style=" position:relative; overflow:hidden"> <i class="fab fa-dropbox" aria-hidden="true" style="    font-size: 50px;    position: absolute;   bottom:0px; right: 0px;    opacity: 0.1;"></i>
