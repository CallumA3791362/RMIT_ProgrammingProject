...
<div class="card card-filter">
  ...
  <a href="#" data-toggle="collapse" data-target="#collapse_distance" aria-expanded="true" >
    <h5 class="card-title"><?php echo __("Distance","premiumpress"); ?></h5>
    </a>
    ...
    <div <?php if(!$CORE->isMobileDevice()){ ?>class="filter-content collapse" id="collapse_distance"<?php }else{ ?> class="pt-2"<?php } ?>>
      ...
      <div class="form-group mb-0 mt-3">
        <select id="radius" name="radius" class="form-control customfilter" data-type="select" data-key="radius"  <?php if(!$CORE->isMobileDevice()){ ?>onchange="_filter_update()" <?php } ?> >
