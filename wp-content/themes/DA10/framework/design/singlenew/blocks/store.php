...
<div class="card p-lg-4 position-relative overflow-hidden"> <i class="fal fa-smile fa-8x text-primary" style="position:absolute; bottom:-25px; right:-15px;"></i>
  ...
  <div class="bg-content text-white p-4">
    ...
    <a <?php if(strlen($storelink) > 2){ ?> href="<?php echo $storelink; ?>" <?php }else{ ?> href="javascript:void(0);" <?php } ?>  class="btn btn-system <?php if(strlen($storelink) == 0){ ?>opacity-5<?php } ?>" ><i class="fal fa-home  mr-2"></i> <?php echo __("Visit Store","premiumpress"); ?></a>
