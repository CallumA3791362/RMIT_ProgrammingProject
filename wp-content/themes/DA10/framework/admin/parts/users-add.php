    ...
    <div class="card">
      <div class="card-body">
        ...
        <ul class="nav nav-tabs mt-4"   role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link" id="social-tab" data-toggle="tab" href="#social" role="tab" aria-controls="password" aria-selected="false"><?php echo __("Social","premiumpress"); ?></a> </li>
          ...
          <li class="nav-item"> <a class="nav-link" id="orderhistoryt-tab" data-toggle="tab" href="#orderhistoryt" role="tab" aria-controls="orderhistoryt" aria-selected="false"><?php echo __("Order History","premiumpress"); ?></a> </li>
        </ul>
            ...
            <div class="row">
             ...
             <div class="col-md-12 mb-3">
                <div class="form-group">
                  ...
                  <input class="form-control required-field val-nospaces" type="text" id="newusernamefield" name="user_login" style="height:50px !important;" value="<?php 
          ...
          <?php } ?>
            ...
            function ajax_update_citylist(){
              ...
              <div class="col-12">
                <div class="card-body-grey">
                  <div class="step">
                    <h3 class="mb-1 mt-4">Account</h3>
                  </div>
                  <hr />
                </div>
                <div>Account Notice</div>
    ...
    <article class=" card mb-4">
      ...
      <div class="filter-content collapse show" id="collapse_2">
        <div class="card-body ">
          ...
          <div class="p-3 bg-light text-muted small">Here you can set an amount in monies that will be credited to the users account. If the value is negative, the users account will show payment options for them to pay.</div>
        </div>
      </div>
    </article>
